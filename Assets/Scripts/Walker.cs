...
//Можно исправить поменяв стартовое знаечение направления, но это не решение. Хочу понять проблему. Если закомментить Рейкаст хит, то все ок.
//Более того, при покадровом проигровании свинья идет куда нужно. А в плей моде нет.
